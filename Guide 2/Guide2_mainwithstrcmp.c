...
void read_enable(){
	getstring2();
		if(strcmp(rxbuff,"EN 0")== 0){
			printf("enable 0\n");
		}
		else if(strcmp(rxbuff,"EN 1")){
			printf("enable 1\n");
		}
		else error();
}
...
void state_validation(){
	...
	if (strcmp(rxbuff,"CR 0")== 0) {
	                    currentState = STATE_RESET;
	        }
	else if (strcmp(rxbuff,"CR 1")== 0) {
	                            currentState = STATE_RESET;
	        }
	else if (strcmp(rxbuff,"CR 2")== 0) {
	                            currentState = STATE_RESET;
	        }
	else if (strcmp(rxbuff,"CR 3")== 0) {
	                            currentState = STATE_RESET;
	        }
	else if (strcmp(rxbuff,"CR4")== 0) {
	                            currentState = STATE_RESET;
	        }
